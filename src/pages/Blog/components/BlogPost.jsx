      ...
      <div className="relative flex flex-col sm:flex-row gap-8">
        <article className="flex-1 text-secondary-color">
          <div className="bg-white rounded-md p-3">
            ...
            <NavLink
              className={
                "block mb-5 py-1 text-gray-600 hover:text-gray-800 hover:font-bold hover:animation-fade text-sm border-b border-t border-gray-500/20"
              }
              to={`/blog/#section1`}
            >
              Section 1
            ...
            <NavLink
              className={
                "block mb-5 py-1 text-gray-600 hover:text-gray-800 hover:font-bold hover:animation-fade text-sm border-b border-gray-500/20"
              }
              to={`/blog/#section2`}
            >
              Section 2
            ...
            <NavLink
              className={
                "block mb-5 py-1 text-gray-600 hover:text-gray-800 hover:font-bold hover:animation-fade text-sm"
              }
              to={`/blog/#section7`}
            >
              Section 7
        ...
        <article className="flex-[50%] mx-auto">
          <div id="section1" className="mb-8">
            ...
            <p className="text-gray-900">
              The PIN (Personal Identification Number) code is a password, which
              must be enabled to prevent any other person without your
              authorization from accessing your mobile phone.
            </p>
            <p className="text-gray-900 my-5">
              The PIN is a numerical code that you have to enter every time you
              want to start your device (unless you have disabled the PIN
              security feature).
            </p>
            <p className="text-gray-900">
              The PIN is associated with the SIM card (not the phone) and must
              be entered each time the phone is switched on. If a wrong PIN code
              is entered three times in a row, your mobile phone will be locked.
              To unlock it you will have to dial the PUK code.
            </p>
          </div>
